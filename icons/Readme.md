...
- Code: code editors (Visual Studio Code, etc.)
...
- Code: I made it myself in Photoshop and [Effect.app](https://effect.app/). Font: [Modern DOS](https://www.dafont.com/modern-dos.font).
- Floppy: based on [Vintage Disk Mockup](https://mrmockup.com/vintage-disk-mockup/), a photo of an actual floppy disk and my own handwriting
