...
user_pref('ui.textSelectAttentionBackground', '#db7097'); // Squirrelsong Light brightPink
user_pref('ui.textSelectAttentionForeground', '#fdfdfe'); // Squirrelsong Light gray180
// Search highlight all colors
user_pref('ui.textHighlightBackground', '#fae1ea'); // Squirrelsong Light brightPinkDimer
