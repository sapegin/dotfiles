...
4. Focus on issues that cannot be detected by typecheck, lint, tests, or build alone. Assume they are clear and do not run them.
5. Prefer small, clear fixes over cleverness, abstractions, or future-proofing.
